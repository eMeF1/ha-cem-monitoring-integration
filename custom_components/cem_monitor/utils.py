...
def get_int(d: dict[str, Any], *keys: str) -> int | None:
    """
...
def get_str(d: dict[str, Any], *keys: str) -> str | None:
    """
...
def get_str_nonempty(*vals: str | None) -> str | None:
    """
